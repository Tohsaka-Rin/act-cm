# -*- coding:UTF-8 -*-
from act_db.models import GroupInfo,PatientGroup,RelationInfo,OutPatientServiceInfo,EmergCallInfo,InHospitalInfo,Clinic,ESS,MBQ,SGRO,AttachInfo,AccessoryExamination
...
def deleteExpGroup(D_id,G_id):
    ...
    try:
        ...
        group.delete()
        # 没有使用外码
        PatientGroup.objects.filter( ).delete()
        return True
    except:
        return False
